...
Due April 13th<sup>ish</sup> Select a dataset that interests you. For the proposal, you need to answer the questions below.
...
More information including template and suggested datasets located here: https://spring2026.data606.net/assignments/project/
...
```{r, echo=FALSE}
knitr::include_graphics('images/xkcd_significant1.png')
```
...
knitr::include_graphics('images/xkcd_significant2.png')
```
...
```{r, echo=FALSE}
knitr::include_graphics('images/xkcd_significant3.png')
```
