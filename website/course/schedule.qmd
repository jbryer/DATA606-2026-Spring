...
Note that this schedule will be updated as the semester progresses, with all changes documented here. **Meetups will be `r class_day` from `r class_time` unless noted otherwise.** If you cannot attend live, we expect you to watch the recordings. Information not in the textbook or this website will be presented.
