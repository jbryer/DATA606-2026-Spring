...
start_day <- lubridate::floor_date(min(c(meetups$day, topics$Start), na.rm = TRUE), "month")
end_day <- lubridate::ceiling_date(max(c(meetups$day, topics$End), na.rm = TRUE), "month") - 1
```
